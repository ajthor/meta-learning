...
from meta_learning.fomaml import adapt_model, meta_update_step, clone_model
...
# Training loop
print("Starting FOMAML training...")
meta_losses = []
...
plt.title('FOMAML Training - Meta Loss')
plt.xlabel('Epoch')
plt.ylabel('Meta Loss')
plt.yscale('log')
plt.grid(True)
plt.savefig('/workspaces/meta-learning/fomaml_training_curve.png')
plt.show()
